...
The tool
  ...
  * decodes each chunk by recursive descent from offset 0 (operand lengths
    ...
    ai_fusion.c and ai_script_end.c; see notes/ai-hard-mode-research.md),
...
"""
# Imported from krystalgamer/memories-decomp PR #6006, commit
# 2a9a0f2598564712a2945e9e695ee232cfcf5402 (2026-09-24 research baseline).
# Local research and corrections: notes/ai-hard-mode-research.md.
import argparse
import collections
import csv
import hashlib
